                  ...
                  >
                    ...
                    <div className="flex items-center gap-2.5 w-full md:w-auto shrink-0">
                      <button
                        ...
                        className="press flex-1 md:flex-none min-h-10 px-4 rounded-btn bg-secondary text-xs font-bold hover:bg-secondary-hover flex items-center justify-center gap-1.5 cursor-pointer"
                      >
                      ...
                      {isSubscribed ? (
                        <button
                          ...
                          className="press flex-1 md:flex-none min-h-10 px-5 rounded-btn text-xs font-bold text-white hover:brightness-105 flex items-center justify-center gap-1.5 cursor-pointer"
                          style={{ backgroundColor: config.theme.primary }}
                        >
                        ...
                        <button
                          ...
                          className="press flex-1 md:flex-none min-h-10 px-5 rounded-btn bg-primary text-primary-foreground text-xs font-bold hover:bg-primary-hover flex items-center justify-center gap-1 cursor-pointer"
                        >
