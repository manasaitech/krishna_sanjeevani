...
export const artSleep = require("@/assets/images/art-sleep.jpg");
export const artFocus = require("@/assets/images/art-focus.jpg");
export const artHealing = require("@/assets/images/art-healing.jpg");
