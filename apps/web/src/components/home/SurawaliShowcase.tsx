...
import { Activity, Baby, Briefcase, Clock, Sparkles, ChevronRight, ArrowRight } from "lucide-react";
  ...
  const tabs = [
    {
      ...
      description:
        "Sound frequency compositions calibrated for physical and neurological conditions. These streams act as non-invasive supportive therapy based on Raga Chikitsa.",
    },
    {
      ...
      description:
        "Month-by-month acoustic guidance calibrated to support maternal hormonal equilibrium, reduce stress, and enhance healthy fetal cognitive development.",
    },
    {
      ...
      description:
        "Circadian-aligned ragas designed to lower stress levels, enhance workspace focus, and restore mental clarity during the workweek.",
    },
  ];
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-3xl mx-auto mb-16">
            ...
            <p className="mt-3 text-sm text-muted-foreground font-sans leading-relaxed">
              Vedic raga sound therapy structured across three core areas of life: ailments
              recovery, month-by-month pregnancy care, and weekly corporate focus.
            </p>
          </div>
              ...
              <div className="rounded-3xl border border-border/60 bg-surface p-6 sm:p-8 shadow-lift space-y-6">
                ...
                <div className="space-y-3 pb-6 border-b border-border/60">
                  <div className="flex flex-wrap items-center justify-between gap-3">
                    <span
                      className={`inline-flex items-center gap-1.5 rounded-full px-3.5 py-1 text-xs font-bold uppercase tracking-wider border ${activeTabDetails.colorClass}`}
                    >
                ...
                <div className="rounded-2xl bg-gradient-to-br from-cat-light/40 via-cat-light/10 to-transparent border border-cat-accent/15 p-5 flex flex-col sm:flex-row items-center justify-between gap-4">
                  <div className="space-y-1 text-center sm:text-left">
                    ...
                    <p className="text-xs text-muted-foreground leading-relaxed font-sans">
                      Subscribe to unlock all full-length {activeTabDetails.label.toLowerCase()}{" "}
                      compositions.
                    </p>
                  </div>
