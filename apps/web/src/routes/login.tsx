      ...
      <div className="ks-frame">
        ...
        <div className="ks-medallion-wrap">
          ...
          <div className="ks-medallion-inner">
            <img src="/images/krishna-medallion.jpg" alt="Krishna medallion" className="ks-medallion-img" />
          </div>
        ...
        <div className="ks-wave" aria-hidden="true">
          {waveHeights.map((h, i) => (
            <span key={i} className="ks-bar" style={{ animationDelay: `${i * 0.12}s`, "--wh": h } as React.CSSProperties} />
          ))}
        </div>
        ...
        <div className="ks-rule-row" aria-hidden="true">
          <span className="ks-rule" /><span className="ks-lotus">🪷</span><span className="ks-rule" />
        </div>

        {/* Description */}
        <p className="ks-desc">
          Therapeutic ragas &amp; surāvalis, sequenced by therapists for stress relief,
          sleep, focus, and pregnancy wellbeing.
        </p>

        {/* CTA */}
        <Link to="/register" id="ks-get-started-btn" className="ks-primary" aria-label="Get Started">
        ...
        <div className="ks-pair">
          <Link to="/login" id="ks-sign-in-btn" className="ks-secondary" aria-label="Sign in">
            <User className="ks-ico-sm" aria-hidden="true" /><span>Sign in</span>
          </Link>
          <Link to="/register" id="ks-create-account-btn" className="ks-secondary" aria-label="Create account">
            <UserPlus className="ks-ico-sm" aria-hidden="true" /><span>Create account</span>
          </Link>
        </div>

        {/* Divider */}
        <div className="ks-flute" aria-hidden="true">
          <span className="ks-rule" /><span className="ks-flute-ico">🪈🦚</span><span className="ks-rule" />
        </div>

        {/* Social */}
        <button id="ks-google-btn" type="button" onClick={handleGoogleSignIn} className="ks-social" aria-label="Continue with Google">
        ...
        <button id="ks-apple-btn" type="button" onClick={handleAppleSignIn} className="ks-social" aria-label="Continue with Apple">
          <svg className="ks-social-ico" viewBox="0 0 24 24" aria-hidden="true">
            <path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z" fill="#1a1208" />
          </svg>
        ...
        <p className="ks-legal">
          ...
          <Link to="/terms" className="ks-link">Terms</Link> and{" "}
          <Link to="/privacy" className="ks-link">Privacy Policy</Link>.
        </p>
      </div>
