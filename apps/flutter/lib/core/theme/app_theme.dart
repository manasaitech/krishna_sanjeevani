    ...
    return ThemeData(
      ...
      cardTheme: CardThemeData(
        ...
        shape: RoundedRectangleBorder(
          ...
          side: const BorderSide(color: Color(0xFFEFE9DF)),
        ),
      ),
      appBarTheme: const AppBarTheme(
        backgroundColor: Color(0xFFFAF8F5),
        elevation: 0,
        iconTheme: IconThemeData(color: Color(0xFF4D0F1B)),
        titleTextStyle: TextStyle(color: Color(0xFF4D0F1B), fontSize: 18, fontWeight: FontWeight.bold),
      ),
